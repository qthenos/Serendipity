...
var url = 'https://api.edamam.com/api/food-database/v2/parser';
console.log("API Request URL: ".concat(url, "?app_id=").concat(EDAMAM_APP_ID, "&app_key=").concat(EDAMAM_APP_KEY, "&ingr=apple"));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    console.log("First Item:", (_a = response.data.hints[0]) === null || _a === void 0 ? void 0 : _a.food);
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _b.sent();
                    if (error_1 instanceof Error) {
                        console.error("Error making API request:", error_1.message);
                    }
                    else {
